...
print("""
    ...
    <body>
        <div class="container">
            ...
            </div>""" % (pid, pid, pid, pid, pid,pid,pid))
print("""
            <div class="content">
...
if submit != None:
    ...
    q = """ INSERT INTO feedback_form(name, designation, workingdays, description, rating, street, city, username, useremail, userstreet, usercity,customer_type) VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s') """ % (
    name, designation, workingdays, description, rating, street, city, username, useremail, userstreet, usercity,cs_type)
    cur.execute(q)
    con.commit()
    print(""""
      <script>
